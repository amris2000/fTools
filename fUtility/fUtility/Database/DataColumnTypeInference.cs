...
namespace fUtility
{
    public static class DataColumnTypeInference
    {

        // This coould also be usefull
        // https://stackoverflow.com/questions/5311699/get-datatype-from-values-passed-as-string
        ...
        /// <returns></returns>
        public static Type GetColumnType(DataColumn column, DataTable dt, ref int colSize)
        {
